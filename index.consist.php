...
define('DIR_WWW'          , dirname(__FILE__), false);
define('DIR_VENDOR',       DIR_WWW.'/vendor', false);
...
!defined('PT_DIR_THEME_DEFAULT') && define('PT_DIR_THEME_DEFAULT', DIR_WWW.'/theme', false);
# by default application folder is in www public
# it can be changed to any other folder like APP_DIR_WWW.'/../app-folder'
!defined('PT_DIR_SOURCE') && define('PT_DIR_SOURCE',       DIR_WWW.'/src', false);
